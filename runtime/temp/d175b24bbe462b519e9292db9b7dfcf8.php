<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"C:\wamp64\www\0\auth\public/../application/admin\view\contact\edit.html";i:1492585236;s:69:"C:\wamp64\www\0\auth\public/../application/admin\view\admin\base.html";i:1492509312;}*/ ?>
<!DOCTYPE html>
...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">编辑联系方式》<small>新增|更新</small></h1>
            ...
            <div class="col-md-6 col-sm-6 col-md-offset-3 col-sm-offset-3 col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?php echo url('admin/category/udpate'); ?>" method="post">
                            <div class="form-group">
                                <label class="control-label">生产地址（中文）</label>
                                <input type="text" class="form-control" name="cn_title"/>
                            </div>
                            <div class="form-group">
                                <label class="control-label">生产地址（英文）</label>
                                <input type="text" class="form-control" name="en_title"/>
                            </div>
                            <div class="form-group">
                                <label class="control-label">公司地址（中文）</label>
                                <input type="text" class="form-control" name="cn_title"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>其他联系方式（中文）</label>
                                <textarea class="form-control" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                <label>其他联系方式（英文）</label>
                                <textarea class="form-control" rows="3"></textarea>
                            </div>

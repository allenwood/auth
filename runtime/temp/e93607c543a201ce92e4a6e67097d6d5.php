<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"C:\wamp64\www\0\auth\public/../application/admin\view\category\index.html";i:1492588073;s:69:"C:\wamp64\www\0\auth\public/../application/admin\view\admin\base.html";i:1492586425;}*/ ?>
<!DOCTYPE html>
...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">产品分类</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <p>
                <a class="btn btn-primary" href="<?php echo url('admin/category/edit'); ?>"><i class="glyphicon glyphicon-search"></i>新增</a>
                </p>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>@mdo</td>
                                    <td>
                                        <a class="btn btn-primary btn-xs" href="<?php echo url('admin/category/edit'); ?>"><i class="glyphicon glyphicon-search"></i>编辑</a>
                                        <a class="btn btn-danger btn-xs" href="<?php echo url('admin/category/del'); ?>"><i class="glyphicon glyphicon-home"></i>删除</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2</td>

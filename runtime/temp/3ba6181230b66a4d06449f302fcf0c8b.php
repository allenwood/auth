<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"C:\wamp64\www\0\auth\public/../application/admin\view\events\edit.html";i:1492565353;s:69:"C:\wamp64\www\0\auth\public/../application/admin\view\admin\base.html";i:1492509312;}*/ ?>
<!DOCTYPE html>
...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">编辑新闻》<small>新增|更新</small></h1>
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?php echo url('admin/index/updateslide'); ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="control-label">标题（中文）</label>
                            ...
                            <div class="form-group">
                                <label>内容（中文）</label>
                                <!--<textarea class="form-control" id="editor_cn" rows="3"></textarea>-->
                                <script id="editor_cn" type="text/plain" style="width:100%;height:500px;" name="content_cn"></script>
                            </div>
                            <div class="form-group">
                                <label>内容（英文）</label>
                                <script id="editor_en" type="text/plain" style="width:100%;height:500px;" name="content_en"></script>
                            </div>
                            <div class="form-group">
                                <label>是否置顶</label>
                                <div class="checkbox">
...
<script type="text/javascript" charset="utf-8" src="__STATIC__/admin/assets/ueditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="__STATIC__/admin/assets/ueditor/ueditor.all.min.js"> </script>
<script type="text/javascript">

    $(function(){
        UE.getEditor('editor_cn',{
            autoHeightEnabled: true,
            autoFloatEnabled: false,
            initialFrameHeight:483
        });
        UE.getEditor('editor_en',{
            autoHeightEnabled: true,
            autoFloatEnabled: false,
            initialFrameHeight:483
        });

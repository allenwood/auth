<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"C:\wamp64\www\0\auth\public/../application/admin\view\index\index.html";i:1492497454;s:69:"C:\wamp64\www\0\auth\public/../application/admin\view\admin\base.html";i:1492585636;}*/ ?>
<!DOCTYPE html>
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    ...
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <div class="user-img pull-right">
                                            <img src="__STATIC__/admin/assets/img/user.gif" alt="" class="img-u image-responsive" />
                                        </div>
                                ...
                                <div class="item">
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <h4><i class="fa fa-quote-left"></i>Lorem ipsum dolor sit amet, consectetur adipiscing Lorem ipsum dolor sit amet, consectetur adipiscing elit onec molestie non sem vel condimentum. <i class="fa fa-quote-right"></i></h4>
                                        <div class="user-img pull-right">
                                            <img src="__STATIC__/admin/assets/img/user.png" alt="" class="img-u image-responsive" />
                                        </div>
                                        <h5 class="pull-right"><strong class="c-black">Lorem Dolor</strong></h5>
                                    </div>
                    ...
                    <div id="carousel-example" class="carousel slide" data-ride="carousel" style="border: 5px solid #000;">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <img src="__STATIC__/admin/assets/img/slideshow/1.jpg" alt="" />

                            </div>
                            <div class="item">
                                <img src="__STATIC__/admin/assets/img/slideshow/2.jpg" alt="" />

                            </div>
                            <div class="item">
                                <img src="__STATIC__/admin/assets/img/slideshow/3.jpg" alt="" />
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="media">
                                        <a class="pull-left" href="#">
                                            <img class="media-object img-circle img-comments" src="__STATIC__/admin/assets/img/user.png" />
                                        </a>
                                        <div class="media-body">
                                            ...
                                            <div class="media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle img-comments" src="__STATIC__/admin/assets/img/user.gif" />
                                                </a>
                                                <div class="media-body">
